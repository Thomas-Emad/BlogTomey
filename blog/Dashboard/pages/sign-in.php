...
// Check If User Sign-in?, Don't Open This Page.
session_start();
...
if (isset($_POST['sign'])) {
  ...
  if (isset($answer)) {
    // IF User Checked Remember Save In Cookies Else Use Session.
    if (isset($_POST['remember'])) {
      setcookie('username', $answer[0], (time() + 60 * 60 * 24 * 365), '/');
    } else {
      $_SESSION['username'] = $answer[0];
    }
    header("Location: dashboard.php");
  } else {
                ...
                <div class="card-body">
                  <form role="form" action="" method="POST">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" id="rememberMe" name="remember" value="active">
                    ...
                    <div class="text-center">
                      <input type="submit" name="sign" value="Sign in" class="btn bg-gradient-info w-100 mt-4 mb-0">
                    </div>
                  </form>
                </div>
